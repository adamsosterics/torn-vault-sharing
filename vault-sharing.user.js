...
(function() {
    ...
    function startVaultSharing() {
        ...
        function saveSettings() {
            let ownBalanceSetting = Number(document.getElementById("vault-sharing-own-start-balance").value.replace(/,/g, ""));
            let spouseBalanceSetting = Number(document.getElementById("vault-sharing-spouse-start-balance").value.replace(/,/g, ""));
